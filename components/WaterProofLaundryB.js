...
const WaterProofLaundryB = (props) => {
  ...
  const sendEmail = () => {
    ...
    axios
      .post(
        `${serverClient}/api/v1/waterproof/${props.route.params.id}/send/laundry/b`,
        {
          email: email,
        }
      )
...
export default WaterProofLaundryB;
