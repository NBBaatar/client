...
const UnitBathroomUpdateAfter = (props) => {
  //Before all states
        ...
        bathroom: [
          {
            ...
            photo: [
              {
                fileName: imageName,
                uri: `${serverClient}/uploads/bathroom/after/` + imageName,
              },
            ],
          },
        ],
  ...
  const handleUpdate = () => {
    axios
      ...
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/waterproof/${props.route.params.id}/bathroom-after`
        );
...
export default UnitBathroomUpdateAfter;
