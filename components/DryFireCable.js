...
const DryFireCable = (props) => {
  ...
  const handleUpdate = () => {
    axios
      .put(
        `${serverClient}/api/v1/dryfirecable/${props.route.params.id}`,
        unitFillData
      )
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/dryfirecable/${props.route.params.id}/upload`
        );
