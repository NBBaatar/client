    ...
    kitchen: [
      {
        ...
        photo: [
          {
            fileName: imageName,
            uri: `${serverClient}/uploads/tiles/kitchen/` + imageName,
          },
        ],
      },
    ],
  ...
  const handleUpdate = () => {
    axios
      ...
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/tiles/${props.route.params.id}/upload/kitchen`
        );
