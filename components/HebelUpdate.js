...
const HebelUpdate = (props) => {
  ...
  const handleUpdate = () => {
    axios
      .put(
        `${serverClient}/api/v1/hebel/${props.route.params.id}`,
        unitFillData
      )
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/hebel/${props.route.params.id}/upload`
        );
