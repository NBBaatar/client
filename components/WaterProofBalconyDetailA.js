...
const WaterProofBalconyDetailA = (props) => {
  ...
  const sendEmail = () => {
    ...
    axios
      .post(
        `${serverClient}/api/v1/waterproof/${props.route.params.id}/send/balcony/a`,
        {
          email: email,
        }
      )
...
export default WaterProofBalconyDetailA;
