    ...
    laundry: [
      {
        ...
        photo: [
          {
            fileName: imageName,
            uri: `${serverClient}/uploads/tiles/laundry/` + imageName,
          },
        ],
      },
    ],
  ...
  const handleUpdate = () => {
    axios
      ...
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/tiles/${props.route.params.id}/upload/laundry`
        );
