...
const UnitLandryUpdateBefore = (props) => {
  //Before all states
        ...
        landry: [
          {
            ...
            photo: [
              {
                fileName: imageName,
                uri: `${serverClient}/uploads/landry/before/` + imageName,
              },
            ],
          },
        ],
  ...
  const handleUpdate = () => {
    axios
      ...
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/waterproof/${props.route.params.id}/landry-before`
        );
...
export default UnitLandryUpdateBefore;
