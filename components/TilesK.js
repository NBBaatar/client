...
const TilesK = (props) => {
  ...
  const sendEmail = () => {
    ...
    axios
      .post(
        `${serverClient}/api/v1/tiles/${props.route.params.id}/kitchen/send`,
        {
          email: email,
        }
      )
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#36393e" }}>
      <View style={styles.view1}>
        <Text style={styles.componentHeader}>Tiles {"{Kitchen}"}:</Text>
      </View>
      <Animatable.View animation="bounceInUp" style={styles.view2}>
        ...
        <FormButton
          onPress={() => {
            props.navigation.navigate("Tiles kitchen edit", {
