...
const WaterProofLaundryA = (props) => {
  ...
  const sendEmail = () => {
    ...
    axios
      .post(
        `${serverClient}/api/v1/waterproof/${props.route.params.id}/send/laundry/a`,
        {
          email: email,
        }
      )
...
export default WaterProofLaundryA;
