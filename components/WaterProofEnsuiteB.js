...
const WaterProofEnsuiteB = (props) => {
  ...
  const sendEmail = () => {
    ...
    axios
      .post(
        `${serverClient}/api/v1/waterproof/${props.route.params.id}/send/ensuite/b`,
        {
          email: email,
        }
      )
...
export default WaterProofEnsuiteB;
