...
const WaterProofBalconyDetailB = (props) => {
  ...
  const sendEmail = () => {
    ...
    axios
      .post(
        `${serverClient}/api/v1/waterproof/${props.route.params.id}/send/balcony/b`,
        {
          email: email,
        }
      )
        ...
        <ScrollView>
          <View style={styles.componentContent}>
            ...
            <Text style={styles.textValueStyle}>
              {waterProof?.before?.[0].balcony?.[0].level}
            </Text>
          </View>
          <View style={styles.componentContent}>
            <Text style={styles.textLabelStyle}>Angle: </Text>
            <Text style={styles.textValueStyle}>
              {waterProof?.before?.[0].balcony?.[0].angle}
            </Text>
          </View>
          <View style={styles.componentContent}>
            <Text style={styles.textLabelStyle}>Concrate: </Text>
            <Text style={styles.textValueStyle}>
              {waterProof?.before?.[0].balcony?.[0].concrate}
            </Text>
          </View>
          <View style={styles.componentContent}>
            <Text style={styles.textLabelStyle}>Patch: </Text>
            <Text style={styles.textValueStyle}>
              {waterProof?.before?.[0].balcony?.[0].patch}
            </Text>
          </View>
          <View style={styles.componentContent}>
            <Text style={styles.textLabelStyle}>Sub straight: </Text>
            <Text style={styles.textValueStyle}>
              {waterProof?.before?.[0].balcony?.[0].subStraight}
            </Text>
          </View>
          <View
            style={{
...
export default WaterProofBalconyDetailB;
