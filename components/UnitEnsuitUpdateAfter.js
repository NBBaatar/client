...
const UnitEnsuitUpdateAfter = (props) => {
  //Before all states
        ...
        ensuit: [
          {
            ...
            photo: [
              {
                fileName: imageName,
                uri: `${serverClient}/uploads/ensuit/after/` + imageName,
              },
            ],
          },
        ],
  ...
  const handleUpdate = () => {
    axios
      ...
      .then((response) => {
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/waterproof/${props.route.params.id}/ensuit-after`
        );
...
export default UnitEnsuitUpdateAfter;
