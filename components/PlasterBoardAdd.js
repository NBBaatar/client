...
const PlasterBoardAdd = (props) => {
  ...
  const handleUpdate = () => {
    axios
      .post(`${serverClient}/api/v1/plasterboard`, unitFillData)
      .then((response) => {
        const newPlasterBoard = response.data.data;
        ...
        xhr.open(
          "PUT",
          `${serverClient}/api/v1/plasterboard/${newPlasterBoard._id}/upload`
        );
...
export default PlasterBoardAdd;
